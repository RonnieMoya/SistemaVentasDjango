...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sVentas', '0002_alter_usuario_options_alter_usuario_table'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sVentas.category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cli', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sVentas.client')),
            ],
            options={
                'verbose_name': 'Venta',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtotal', models.DecimalField(decimal_places=2, default=0.0, max_digits=9)),
                ('prod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sVentas.product')),
                ('sale', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sVentas.sale')),
            ],
            options={
